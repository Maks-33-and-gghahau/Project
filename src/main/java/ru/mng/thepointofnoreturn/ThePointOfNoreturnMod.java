...
@Mod("the_point_of_noreturn")
public class ThePointOfNoreturnMod {
	public static final Logger LOGGER = LogManager.getLogger(ThePointOfNoreturnMod.class);
	public static final String MODID = "the_point_of_noreturn";

	public ThePointOfNoreturnMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);

		ThePointOfNoreturnModBlocks.REGISTRY.register(modEventBus);
		ThePointOfNoreturnModBlockEntities.REGISTRY.register(modEventBus);
